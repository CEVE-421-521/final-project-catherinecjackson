...
The following project seeks to improve both the accuracy of storm surge inputs as well as the accuracy of the damage functions used in the decision-support tool. In the current model, storm surge is input as 
